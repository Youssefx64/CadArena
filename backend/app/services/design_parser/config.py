...
HF_MODEL_ID = "LiquidAI/LFM2-1.2B-Extract"
OLLAMA_GENERATE_URL = os.getenv("CADARENA_OLLAMA_URL", "http://localhost:11434/api/generate")
REQUEST_TIMEOUT_SECONDS = _env_float("CADARENA_PARSER_TIMEOUT_SECONDS", 45.0)
MAX_NEW_TOKENS = _env_int("CADARENA_PARSER_MAX_NEW_TOKENS", 1024)
HF_EAGER_LOAD = _env_bool("CADARENA_HF_EAGER_LOAD", False)
HF_MAX_CONCURRENCY = _env_int("CADARENA_HF_MAX_CONCURRENCY", 1)
