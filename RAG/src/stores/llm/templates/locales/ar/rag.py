...
# This prompt is used to instruct the LLM on how to generate a response to the user's query.
...
#### Document ####
# This prompt is used to format the documents that are passed to the LLM.
...
#### Footer ####
# This prompt is used to instruct the LLM to generate a response to the user's query based on the provided documents.
